	...
	public boolean bookJourney(Traveller[] traveller,FlightInstance[] flightInstance,PaymentDetails paymentDetails,Person[] person)
	{
		...
		if(isDuplicate == false)
		{
			...
			for(int i = 0;i<flightInstance.length;i++)
			{
					...
					insertInFlightSeat1.setInt(1, Integer.parseInt((flightInstance[i].getFlight_no())));
					...
					insertInFlightSeat2.setInt(2, Integer.parseInt((flightInstance[i].getFlight_no())));
			...
			insertIntoJourney1.setString(7, flightInstance[0].getArrivalTime());
			...
			for(int l=0;l<flightInstance.length;l++)
			{
				...
				insertJourneyFlight.setInt(1, Integer.parseInt(flightInstance[l].getFlight_no()));
